...
FORCESUB_CHANNEL = int(os.environ.get("FORCESUB_CHANNEL", "-1002115482280"))
FORCESUB_CHANNEL2 = int(os.environ.get("FORCESUB_CHANNEL2", "-1001802782627"))
FORCESUB_CHANNEL3 = int(os.environ.get("FORCESUB_CHANNEL3", "-1001793723818"))
...
USER_REPLY_TEXT = "Join @DelightNetwork for latest updates"
